...
> **Origem:** Esboço manual + complementação técnica
...
- [ ] Historico de tentativas de entrega com data/hora e observação
...
Banco de dados: PostgreSQL (relacional, suporte a transações)
Autenticação:   JWT + Refresh Token
Cache:          Redis (sessões, alertas, dashboard)
Fila/Alertas:   Bull/BullMQ ou similar para notificações e relatórios assíncronos
...
*Documento gerado com base no esboço manual fornecido + complementação técnica para desenvolvimento assistido por IA.*